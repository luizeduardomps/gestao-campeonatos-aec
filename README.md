...
- [x] **ID 04** - Utiliza componentes prontos de um Framework CSS (card, button) e componentes JS (modal, carousel).
- [x] **ID 05** - Cria layout fluido usando unidades relativas (vw, vh, %, em, rem).
- [x] **ID 06** - Aplica um Design System consistente em toda a aplicação.
- [x] **ID 07** - Utiliza Sass (SCSS) aplicando variáveis, mixins e funções.
- [x] **ID 08** - Aplica tipografia responsiva ou tipografia fluida.
- [x] **ID 09** - Aplica técnicas de responsividade de imagens usando CSS (object-fit).
- [x] **ID 10** - Otimiza imagens usando formatos modernos (WebP) e carregamento adaptativo.
